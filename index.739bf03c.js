...
var _champions = require("./champions");
var _championsDefault = parcelHelpers.interopDefault(_champions);
var champions = [];
...
async function startChampions() {
    ...
    for(const key in data)champions.push(new (0, _championsDefault.default)(data[key]));
    await showchampions();
}
...
},{"./champions":"ftYrc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ftYrc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["l9Mez","ebWYT"], "ebWYT", "parcelRequiree079")
